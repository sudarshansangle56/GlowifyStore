...
function Why() {
  return (
    <div className="w-full h-[700px] mt-[120px] px-10 flex justify-between">
      <div className=" w-[50%]  h-[700px] sm:ml-[100px] p-2">
        ...
        <div className="text-[35px] text-[#2d4b3d] font-[450] leading-[35px] my-3">
          <h1>YOUR SKIN DESERVES <br /> THE BEST CARE.</h1>
        </div>
      ...
      <div className=" w-[50%] flex items-center justify-center h-[700px]">
        <img
          src="eyelef.png"
