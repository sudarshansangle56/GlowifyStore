...
function Para() {
  return (
    <div className='flex items-center justify-center h-[300px]'>
      <p className='w-[80%] text-[25px] font-thin'>
        <b>Experience the ultimate in skincare with our expertly formulated products,
crafted to nourish, protect, and rejuvenate your skin. Combining the finest
natural ingredients with </b>advanced science, our collection ensures every
